...
public class TestRakeL {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String testarffFilename = "C:\\Users\\Hitesh\\workspace\\YelpReviewClassification\\resources\\data\\test.arff";
        String xmlFilename = Utils.getOption("xml", args); // e.g. -xml emotions.xml
        String resultFileName = "C:\\Users\\Hitesh\\Dropbox\\YelpChallenge\\output\\ClassifierOutput\\Rakel.txt";
        ...
        RAkEL learner = new RAkEL(new LabelPowerset(new J48()));
